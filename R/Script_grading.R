...
conditionals.codes.list.NOX <- list (
  ...
  D="(lazylogic (e = 'geooutlier == 1') | lazylogic (e = 'hyperhuman == 1') | centroids == 1 ) &  (lazylogic ('outlierEnvironment == 1') )",
  C="lazylogic('outlierEnvironment == 1')",
  B="(lazylogic (e = 'geooutlier == 1')  |  lazylogic (e = 'hyperhuman == 1') | centroids == 1)",
  A=NA
)
...
descriptors.codes.list.NOX <- list(
  ...
  D=list ("GeoEnvOutlier",
          ...
          "if(lazylogic (e = 'hyperhuman == 1')) {'HighHumanEnvironment'}",
