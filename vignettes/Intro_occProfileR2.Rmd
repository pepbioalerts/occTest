...
library(occProfileR)
outMartesMartes = occProfileR::occurrenceClassify(sp.name='Martes martes', sp.table = occ.data,r.env = environmentRaster)
...
out = occurrenceClassify(sp.name='Martes martes', sp.table = occ.data,r.env = environmentRaster, 
